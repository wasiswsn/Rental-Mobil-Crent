									...
									?>	
										<tr>
											...
											<td class="text-center">
												<a href="useredit.php?email=<?php echo $result['email'];?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
												...
												<a href="userdel.php?email=<?php echo $result['email'];?>" onclick="return confirm('Apakah anda yakin akan menghapus pengguna <?php echo $result['email'];?>?');"><i class="fa fa-close"></i></a>
											</td>
										</tr>
										<?php } ?>
