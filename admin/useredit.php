...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['change'])) {
        $name = mysqli_real_escape_string($koneksidb, $_POST['nama']);
        $telp = mysqli_real_escape_string($koneksidb, $_POST['telp']);
        $alamat = mysqli_real_escape_string($koneksidb, $_POST['alamat']);
        $email = mysqli_real_escape_string($koneksidb, $_POST['email']);

        $sql = "UPDATE users SET nama_user='$name', telp='$telp', alamat='$alamat' WHERE email='$email'";
							...
							<div class="col-md-12">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										...
										?>
										<form method="post" class="form-horizontal" name="theform"  onsubmit="return valid(this);" enctype="multipart/form-data">
									...
									<div class="form-group">
										<div class="col-sm-3">
											<div class="checkbox checkbox-inline">
												<button class="btn btn-primary" type="submit" name="change" style="margin-top:4%">Save changes</button>
											</div>
										</div>
									</div>
								</div>
