...
if(strlen($_SESSION['ulogin'])==0){ 
    ...
    if(isset($_POST['submit'])){
        ...
        // Function to generate the next TRX code
        function getNextTRXCode($koneksidb) {
            $sql = "SELECT MAX(CAST(SUBSTRING(kode_booking, 4) AS SIGNED)) AS max_code FROM booking";
...
<title>rental mobil sewa page</title>
<!--Bootstrap -->
